(() => {
    const width = 960;
    const height = 600;
    const margin = { top: 60, right: 180, bottom: 140, left: 100 };
    ...
    d3.csv("/data/Section-5/owid-covid-data.csv").then(data => {
        ...
        svg.append("text")
            ...
            .attr("y", height - margin.bottom + 45) // Adjusted position
        ...
        processedData.forEach(group => {
            ...
            svg.append("rect")
                ...
                .attr("fill", "#42A5F5")
                .attr("stroke", "#1E88E5")
                .on("mouseover", () => vaccinationEconomicRecoveryTooltip.style("visibility", "visible"))
                .on("mousemove", (event) => {
                ...
                .on("mouseout", () => vaccinationEconomicRecoveryTooltip.style("visibility", "hidden"));
